	...
	\end{align}
	\textbf{Claim 7.2.1}: The solution to this system of differential equations are great circles:
	...
	\begin{equation}
		...
		+ \big(\sin\theta\,\ddot{\varphi} + 2\cos\theta\,\dot{\theta}\dot{\varphi}\big)\mathbf{e}_\varphi
		+ \big(-\dot{\theta}^2 - \sin^2\theta\,\dot{\varphi}^2\big)\mathbf{e}_r. \label{eq:accel}
	\end{equation}
