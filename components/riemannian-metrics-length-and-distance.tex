	...
	\begin{definition}\label{dfn:riemannian-metric}
		Let $M$ be a smooth manifold. A \emph{Riemannian metric} $g$ on $M$ is a smooth section of $T^*M\otimes T^*M$. More intuitively, $g$ is a smooth assignment to each point
